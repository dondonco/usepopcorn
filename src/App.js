          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>You rated this movie with {rating} ⭐</p>
              )}
            </div>
            <p>
              <em>{plot}</em>
...
export default function App() {
  ...
  // http://www.omdbapi.com/?apikey=4a47446d&
    ...
    <>
      ...
      <Main>
        ...
        <Box>
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MovieList movies={movies} setSelectedId={handleSelectedMovie} />
          )}
